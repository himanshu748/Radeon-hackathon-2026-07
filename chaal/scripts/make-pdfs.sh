...
#
# Track 3 requires a Technical Report as a PDF, plus supplementary
# material.
#
...
render docs/report.md    "Chaal, Technical Report (Track 3, Physical AI Challenge)" technical-report.pdf
render docs/upstream.md  "Chaal, Supplementary: two Genesis findings"           upstream-findings.pdf
